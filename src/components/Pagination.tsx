      ...
      .map((_, index) => {
        ...
        return (
          <Link
            ...
            key={index}
            className={`${pageNumber === page ? 'bg-blue-600 text-white' : ''} flex items-center justify-center px-4 py-2 max-w-[46px] mx-1 rounded cursor-pointer shadow-sm border border-white/80 text-white/80 hover:border-white hover:text-white active:scale-90`}
          >
            {pageNumber}
          </Link>
        )

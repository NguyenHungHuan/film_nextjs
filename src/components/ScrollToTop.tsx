...
const ScrollToTop = () => {
  ...
  return (
    <button
      ...
      className={`active:scale-75 hidden lg:flex fixed p-2 bottom-6 right-6 items-center justify-center aspect-square rounded-full shadow-md border border-gray-500 bg-gray-900 -rotate-45 transition-all duration-200 sm:bottom-6 sm:right-6 ${
        isShow ? ' opacity-100 pointer-events-auto' : ' opacity-0 pointer-events-none translate-y-3'
      }`}
    >
      <svg
        aria-hidden='true'
